...
lemma finite_retention_blocks_extra_snapshot_exposure_in_actual_ki_game_probability_one :
  phoare [BeeKemExactRetentionGame.main_with_fixed_bit :
       users = [beekem_witness_user]
    /\ group = beekem_witness_group
    /\ kappa = 1
    /\ membership = beekem_witness_membership
...
lemma disabling_finite_retention_reaches_actual_ki_game_probability_one :
  phoare [BeeKemDisabledRetentionGame.main_with_fixed_bit :
       users = [beekem_witness_user]
    /\ group = beekem_witness_group
    /\ kappa = 1
    /\ membership = beekem_witness_membership
