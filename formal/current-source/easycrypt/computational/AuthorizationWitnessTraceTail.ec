...
lemma witness_fact_5_shape_valid :
  authorization_fact_shape_valid witness_fact_5.
proof.
  by rewrite /authorization_fact_shape_valid
    /authorization_fact_shape_valid_kind /witness_fact_5.
qed.

lemma witness_fact_5_id_fresh :
  witness_fact_5.`af_id \notin witness_authorization_state_4.`as_fact_ids.
proof.
  rewrite /witness_fact_5 /witness_authorization_state_4
...
lemma witness_alice_active_state_4 :
  member_active Production witness_authorization_state_4 witness_alice.
proof.
  rewrite /member_active /witness_authorization_state_4
    /witness_member_grant_alice_entry /principal_matches /defense_enabled.
  smt(in_fset1 in_fset0).
qed.

lemma witness_fact_5_issuer_allowed :
  authorization_issuer_allowed
...
proof.
  by rewrite /authorization_issuer_allowed /genesis_authorization_fact
    /witness_fact_5 witness_alice_active_state_4.
qed.

lemma witness_beekem_tag_unknown_state_4 :
  capability_tag_known
    witness_authorization_state_4
    witness_capability_tag_alice_beekem = false.
proof.
  rewrite /capability_tag_known /witness_authorization_state_4
    /witness_capability_grant_alice_admin_entry
    /witness_capability_grant_alice_history_entry
    /witness_capability_grant_alice_puncture_entry
    /witness_capability_tag_alice_admin
...
lemma witness_fact_5_kind_application :
  apply_authorization_fact_kind
    witness_fact_5.`af_kind
    witness_authorization_state_4
    witness_fact_5 =
  Some witness_authorization_state_5.
proof.
  rewrite /apply_authorization_fact_kind /witness_fact_5
    /witness_authorization_state_4 /witness_authorization_state_5
    /witness_capability_grant_alice_admin_entry
    /witness_capability_grant_alice_history_entry
    /witness_capability_grant_alice_puncture_entry
    ...
    /witness_capability_tag_alice_puncture
    /witness_capability_tag_alice_beekem
    /witness_context_5 /capability_tag_known;
  cbv delta;
  by smt(in_fsetU in_fset1).
qed.
...
lemma witness_fact_5_transition :
  ...
  Some witness_authorization_state_5.
proof.
  rewrite /apply_authorization_fact witness_fact_5_shape_valid
    witness_fact_5_id_fresh witness_fact_5_issuer_allowed.
  exact witness_fact_5_kind_application.
qed.

lemma witness_fact_6_shape_valid :
  authorization_fact_shape_valid witness_fact_6.
proof.
  by rewrite /authorization_fact_shape_valid
    /authorization_fact_shape_valid_kind /witness_fact_6.
qed.

lemma witness_fact_6_id_fresh :
  witness_fact_6.`af_id \notin witness_authorization_state_5.`as_fact_ids.
proof.
  rewrite /witness_fact_6 /witness_authorization_state_5
    /witness_context_5 /witness_context_4 /witness_context_3
    /witness_context_2 /witness_context_1 /witness_fact_id_1
    /witness_fact_id_2 /witness_fact_id_3 /witness_fact_id_4
    /witness_fact_id_5 /witness_fact_id_6.
  smt(in_fsetU in_fset1).
qed.

lemma witness_alice_active_state_5 :
  member_active Production witness_authorization_state_5 witness_alice.
proof.
  rewrite /member_active /witness_authorization_state_5
    /witness_member_grant_alice_entry /principal_matches /defense_enabled.
  smt(in_fset1 in_fset0).
qed.

lemma witness_fact_6_issuer_allowed :
  authorization_issuer_allowed
...
proof.
  by rewrite /authorization_issuer_allowed /genesis_authorization_fact
    /witness_fact_6 witness_alice_active_state_5.
qed.

lemma witness_bob_old_member_tag_unknown_state_5 :
  member_tag_known
    witness_authorization_state_5
    witness_member_tag_bob_old = false.
proof.
  rewrite /member_tag_known /witness_authorization_state_5
    /witness_member_grant_alice_entry
    /witness_member_tag_alice /witness_member_tag_bob_old.
  smt(in_fset1).
qed.

lemma witness_bob_old_not_retired_state_5 :
  witness_bob_old \notin
    witness_authorization_state_5.`as_retired_principals.
proof.
  by rewrite /witness_authorization_state_5; smt(in_fset0).
qed.

lemma witness_fact_6_kind_application :
  apply_authorization_fact_kind
    witness_fact_6.`af_kind
    witness_authorization_state_5
    witness_fact_6 =
  Some witness_authorization_state_6.
proof.
  rewrite /apply_authorization_fact_kind /witness_fact_6
    /witness_authorization_state_5 /witness_authorization_state_6
    /witness_member_grant_alice_entry
    /witness_member_grant_bob_old_entry
    /witness_member_tag_alice /witness_member_tag_bob_old
    /witness_context_6 /member_tag_known;
  cbv delta;
  by smt(in_fsetU in_fset1 in_fset0).
qed.
...
lemma witness_fact_6_transition :
  ...
  Some witness_authorization_state_6.
proof.
  rewrite /apply_authorization_fact witness_fact_6_shape_valid
    witness_fact_6_id_fresh witness_fact_6_issuer_allowed.
